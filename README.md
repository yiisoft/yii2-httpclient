...
[![codecov](https://img.shields.io/codecov/c/github/yiisoft/yii2-httpclient.svg?style=for-the-badge&logo=codecov&logoColor=white&label=Codecov)](https://codecov.io/gh/yiisoft/yii2-httpclient)
[![Static Analysis](https://img.shields.io/github/actions/workflow/status/yiisoft/yii2-httpclient/static.yml?style=for-the-badge&label=Static)](https://github.com/yiisoft/yii2-httpclient/actions/workflows/static.yml)
...
> - It requires [Yii 2](https://www.yiiframework.com/) `22.0` or higher.
...
```
composer require --prefer-dist yiisoft/yii2-httpclient:^22.0@dev
```

or add

```
"yiisoft/yii2-httpclient": "^22.0@dev"
```
